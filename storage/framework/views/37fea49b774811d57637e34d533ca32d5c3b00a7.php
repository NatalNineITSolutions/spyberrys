...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div id="videoInputWrapper" class="form-group d-none">
                                    <label class="input-label"><?php echo e(trans('admin/main.video')); ?></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="video" id="video" value="<?php echo e(!empty($category) ? $category->video : old('video')); ?>" class="form-control <?php $__errorArgs = ['video'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                        <div class="invalid-feedback"><?php $__errorArgs = ['video'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
