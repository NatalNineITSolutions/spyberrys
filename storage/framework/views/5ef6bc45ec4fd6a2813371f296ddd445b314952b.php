                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    ...
                                    <?php $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php if(!empty($affiliate->affiliateUser)): ?>
                                                    <?php echo e($affiliate->affiliateUser->full_name); ?>

                                                <?php else: ?>
                                                    <?php echo e(trans('update.deleted_user')); ?>

                                                <?php endif; ?>
                                            </td>

                                            <td>
                                                <?php if(!empty($affiliate->referredUser)): ?>
                                                    <?php echo e($affiliate->referredUser->full_name); ?>
                                            ...
                                            <td>
                                                <?php echo e(handlePrice($affiliate->getAffiliateRegistrationAmountsOfEachReferral())); ?>

                                            </td>

                                            <td>
                                                <?php echo e(handlePrice($affiliate->getTotalAffiliateCommissionOfEachReferral())); ?>

                                            </td>

                                            <td>
                                                <?php echo e(handlePrice($affiliate->getReferredAmount())); ?>

                                            </td>

                                            <td>
                                                <?php echo e(dateTimeFormat($affiliate->created_at, 'Y M j | H:i')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\spyberrys\resources\views/admin/referrals/history.blade.php ENDPATH**/ ?>