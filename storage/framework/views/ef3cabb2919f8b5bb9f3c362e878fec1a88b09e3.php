...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row login-container">
        <div class="col-12 col-md-6 pl-0 register-image-section">
...
unset($__errorArgs, $__bag); ?>" id="term">
                        <label class="custom-control-label font-14" for="term"><?php echo e(trans('auth.i_agree_with')); ?>
                            ...
                            <a href="pages/terms" target="_blank" class="text-primary font-weight-bold font-14"><?php echo e(trans('auth.terms_and_rules')); ?></a>
                        </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-20">
                    <span class="text-secondary">
                        ...
                        <a href="/login" class="text-primary font-weight-bold"><?php echo e(trans('auth.login')); ?></a>
                    </span>
                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\spyberrys\resources\views/web/default/auth/register.blade.php ENDPATH**/ ?>