<div class="mt-35 py-20 course-teacher-card d-flex align-items-center flex-column course-rightbar">
    ...
    <h3 class="sidebar-title font-16 text-secondary font-weight-bold align-self-start mb-3"><?php echo e(trans('webinars.'.$course->type) .' '. trans('webinars.instructions')); ?></h3>
