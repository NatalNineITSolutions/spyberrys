...
<?php $__env->startSection('content'); ?>
                ...
                <div class="user-select-none d-flex flex-column align-items-start">
                    ...
                    <?php else: ?>
                        <div class="text-center slider-content">
                            <h2 class="hero_title"><?php echo e($heroSectionData['title']); ?></h2>
    ...
    <?php if(!empty($liveWebinars) && $liveWebinars->isNotEmpty()): ?>
        <div class="live-classes-section container">
            ...
            <div class="live-classes-container">
                ...
                <?php if($liveWebinars->count() > 3): ?>
                    <div class="live-classes-arrows d-flex justify-content-end mb-3" style="gap: 10px;">
                        <button class="arrow-btn live-webinars-prev" type="button">←</button>
                        <button class="arrow-btn live-webinars-next" type="button">→</button>
                    </div>
                <?php endif; ?>
                        ...
                        <div class="">
                            ...
                            <div class="mt-35 d-flex align-items-center">
                                <?php if(
                                    ...
                                    <a href="<?php echo e($becomeInstructorSection['button1']['link']); ?>"
                                ...
                                <?php if(
                                    ...
                                    <a href="<?php echo e($becomeInstructorSection['button2']['link']); ?>"
        ...
        <?php if($homeSection->name == \App\Models\HomeSection::$instructors and !empty($instructors) and !$instructors->isEmpty()): ?>
            <section class="home-sections container py-5 instructor-section">
                    ...
                    <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col">
                            <div class="card h-100 text-center p-3 shadow-sm rounded-4">
                                <img src="<?php echo e($instructor->getAvatar(108)); ?>" alt="<?php echo e($instructor->full_name); ?>"
                                ...
                                <?php if(!empty($instructor->hasMeeting())): ?>
                                    <a href="<?php echo e($instructor->getProfileUrl()); ?>?tab=appointments"
                                        class="btn btn-primary btn-sm rounded-pill mt-auto"><?php echo e(trans('home.reserve_a_live_class')); ?></a>
                                <?php else: ?>
                                    <a href="<?php echo e($instructor->getProfileUrl()); ?>"
                                        class="btn btn-outline-primary btn-sm rounded-pill mt-auto"><?php echo e(trans('public.profile')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="text-center mt-5">
                    <a href="/instructors"
                        class="btn btn-dark text-white d-inline-flex align-items-center px-4 py-2 rounded-pill"
                        style="gap: 10px;">
    ...
    <div class="footer container">
        <div class="footer-subscribe d-block d-md-flex flex-column align-items-center"
