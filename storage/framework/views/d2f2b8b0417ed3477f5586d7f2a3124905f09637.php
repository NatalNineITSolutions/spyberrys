                ...
                <div class="live-classes">
                    <?php $__currentLoopData = $liveWebinars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="live-class-card">
                            <div class="thumbnail-wrapper" style="background-image: url('<?php echo e(asset($webinar->thumbnail)); ?>');">
                                <button class="play-btn"
                                    onclick="openVideoModal(
                                        '<?php echo e(addslashes($webinar->title)); ?>',
                                        '<?php echo e($webinar->video_demo); ?>',
                                        '<?php echo e($webinar->video_demo_source); ?>'
                                    )">
                                </button>
                            </div>
                            <div class="info">
                                <h4><?php echo e($webinar->teacher->full_name ?? 'Unknown'); ?></h4>
