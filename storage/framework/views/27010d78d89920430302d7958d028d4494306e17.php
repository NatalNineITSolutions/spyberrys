                    ...
                    <div class="form-group" id="personal-details-section" style="display: none;">
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input name="full_name" type="text" class="form-control ps-5" id="full_name" placeholder="Enter your full name" value="<?php echo e(old('name', $response_data['data']['name'] ?? '')); ?>" required>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon\www\spyberrys\resources\views/web/default/auth/signup.blade.php ENDPATH**/ ?>