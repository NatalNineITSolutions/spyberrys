...
<nav id="navbar" class="navbar navbar-expand-lg">
    <div class="w-100 header-container">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <a class="navbar-brand navbar-order d-flex align-items-center justify-content-center d-lg-none d-block mr-0 <?php echo e((empty($navBtnUrl) and empty($navBtnText)) ? 'ml-auto' : ''); ?>" href="/">
                    ...
                    <div class="nav">
                        ...
                        <div>
                            <form action="/search" method="get" class="form-inline my-2 my-lg-0 navbar-search position-relative">
                                <input class="form-control mr-5 rounded" type="text" name="search" placeholder="<?php echo e(trans('navbar.search_anything')); ?>" aria-label="Search" style="width: 300px;">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\spyberrys\resources\views/web/default/includes/navbar.blade.php ENDPATH**/ ?>