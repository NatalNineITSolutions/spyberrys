...
<div class="custom-dropdown btn-text-primary">
    ...
    <?php else: ?>
        <button type="button" <?php echo e((empty($userCarts) or count($userCarts) < 1) ? 'disabled' : ''); ?> class="btn-transparent dropdown-toggle cart-button" id="navbarShopingCart" data-toggle="dropdown"
...
<?php /**PATH C:\laragon\www\spyberrys\resources\views/web/default/includes/shopping-cart-dropdwon.blade.php ENDPATH**/ ?>