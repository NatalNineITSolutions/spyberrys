                        ...
                        <div class="">
                            ...
                            <div class="mt-35 d-flex align-items-center">
                                @if (
                                    ...
                                    <a href="{{ $becomeInstructorSection['button1']['link'] }}"
                                ...
                                @if (
                                    ...
                                    <a href="{{ $becomeInstructorSection['button2']['link'] }}"
                            ...
                            <div class="card h-100 text-center p-3 shadow-sm rounded-4">
                                ...
                                @if (!empty($instructor->hasMeeting()))
                                    <a href="{{ $instructor->getProfileUrl() }}?tab=appointments"
                                        class="btn btn-primary btn-sm rounded-pill mt-auto">{{ trans('home.reserve_a_live_class') }}</a>
                                @else
                                    <a href="{{ $instructor->getProfileUrl() }}"
                                        class="btn btn-outline-primary btn-sm rounded-pill mt-auto">{{ trans('public.profile') }}</a>
                                @endif
                            </div>
                        </div>
                    @endforeach
